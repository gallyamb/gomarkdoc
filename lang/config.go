...
type (
	...
	// RepoType is the repository management system type used to browse repository
	RepoType int
...
// Available [RepoType]'s. GitHubRepoType is the default one
const (
	// GitHubRepoType represent the GitHub repository management system
	GitHubRepoType RepoType = iota
	// BitBucketRepoType represent the BitBucket repository management system
	BitBucketRepoType
)
